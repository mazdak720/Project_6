...
def create_or_update_page_in_database(page_id, category_id, page_title, page_text, page_summary, page_html, location='remote'):
	"""
	...
	"""
   	insert_page = u"""
        INSERT INTO page (page_id, category_id, title, page, summary, html)
        VALUES ({}, {}, '{}', '{}', '{}', '{}')
        on conflict (page_id) do 
            UPDATE set category_id = {}, title ='{}', page = '{}', summary = '{}', html = '{}';
    """.format(page_id, category_id, page_title, page_text, page_summary, page_html, 
                        category_id, page_title, page_text, page_summary, page_html)
...
def execute_sql_query(sql_select, location='remote'):
	"""
...
def execute_sql_statement(sql_statement, location='remote'):
	"""
	This function will return run an arbitrary SQL command.
	"""
